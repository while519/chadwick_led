function [ Xq, Yq, time, para, best, exitflag, svds, Rqz, Rq ] = LEDeig( R,Rq, dim, options, para_range, display )
%%
...
switch lower(opt)
    case 'ga'
        ...
        if ~isequal(eta1_upper, eta1_lower) || ~isequal(eta2_upper,eta2_lower) || ...
            ...
            time = cputime;
            [x,fval,exitflag] = ga(@(x) LEDeig_obj(x, R,Rq, dim, obj_type, obj_para),4,[],[],[],[],...
